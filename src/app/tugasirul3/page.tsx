...
export default function Home() {
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-6 py-12">
      ...
      {/* HERO */}
      <h1 className="text-4xl font-bold mb-2">Hello, I'm M. Khoirul Anwar 👋</h1>
      <p className="text-gray-300 text-center max-w-md mb-12">
        Mahasiswa Semester 3 Informatika UNU Yogyakarta
      </p>

      {/* ABOUT */}
      <h2 className="text-2xl font-semibold mb-2">About Me</h2>
      <p className="text-gray-400 text-center max-w-md mb-12">
        Pemuda yang ingin bisa mahir di bidang informatika khususnya fullstack web development, data A.I, dan Cyber Security.
      </p>
      ...
      <p className="text-gray-400 mb-4">1% Skill 99% Doa orang tua</p>
      <a
